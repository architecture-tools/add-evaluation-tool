...
void main() {
  group('DashboardService Edge Cases Tests', () {
    test('_buildMatrixFromData handles NFRs with entries but no matching NFRResponse', () {
    ...
    test('_deriveComponentColumns uses fallback name when component not in parseResponse', () {
    ...
    test('_buildEmptyMatrixData creates rows with zero scores for all components', () {
