...
1. Show requirements files and get approval for the scenarios  and thresholds of success, and use case diagrams.
2. Show figma design and get approval that it matches the desired customer vision for MVP.
