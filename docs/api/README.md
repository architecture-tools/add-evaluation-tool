...
The OpenAPI specification is automatically generated by FastAPI from the backend code. To update:
...
5. GitHub Pages will automatically rebuild and publish the updated documentation
