...
def test_component_and_relationship_metadata_are_not_shared() -> None:
    ...
    component_a = Component(diagram_id=diagram.id, name="API", type=ComponentType.COMPONENT)
    component_b = Component(diagram_id=diagram.id, name="DB", type=ComponentType.DATABASE)
